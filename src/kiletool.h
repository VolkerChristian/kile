...
public:
    ...
    void setPartOfLivePreview() {
        m_isPartOfLivePreview = true;
    }
    bool isPartOfLivePreview() const {
        return m_isPartOfLivePreview;
    }
    ...
    */
    QHash<QString,QString>& paramDict() {
        return m_dictParams;
    }
    ...
    KLocalizedString msg(long n) const {
        return m_messages[n];
    }
...
public:
    void setEntryMap(Config map) {
        m_entryMap = map;
    }
    void setEntry(const QString& key, const QString& value);
    const QString readEntry(const QString& key) const {
    ...
    bool needsToBePrepared() {
        return m_bPrepareToRun;
    }
...
protected:
    ...
    void setToolConfig(const QString& config) {
        m_toolConfig = config;
    }
